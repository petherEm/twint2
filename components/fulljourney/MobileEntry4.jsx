    ...
    return (
        <>
            <NavBar>
                ...
                <TopDesc>
                    <h3>Welcome to WU@TWINT - Fast, reliable, send money service</h3>
                    <h3>This is your first International Payment with TWINT powered by WU</h3>
                    <h3 style={{textAlign: 'center', color: 'lightgreen'}}>ID + Payment Verification required</h3>
                </TopDesc>
            <Main>
